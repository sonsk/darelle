    ...
    <div className="mt-5 md:hidden">
      {isBirthday ? (
        <div>
            ...
            <p className="relative w-10/12 mx-auto top-20 text-center  text-3xl mt-5 font-bold">
            It's my birthday
            </p>
            <p className="relative w-10/12 mx-auto top-20 text-center  text-4xl mt-5 font-light">
        ...
        <div>
            ...
            <p className="relative w-10/12 mx-auto top-20 text-center  text-2xl mt-5 font-light">
            Not yet my birthday
            </p>
            <p className="relative w-10/12 mx-auto top-20 text-center  text-2xl mt-5 font-light">
            ...
            <img src="angry.png" className="angry" alt="angry"/>
            </p>
        </div>
